...
# data_merge_resampled[:1000] = data_merged.resample(rule="200ms").apply(sampling)

days = [ g for n,g in data_merged.groupby(data_merged.index.day)]
...
data_resampled.to_pickle('../../data/interim/01_data_preprocessed.pickle')